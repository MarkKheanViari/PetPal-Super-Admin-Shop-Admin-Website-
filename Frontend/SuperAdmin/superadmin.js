...
async function fetchUserStatistics() {
  try {
    const response = await fetch("http://192.168.168.203/backend/Frontend/Superadmin/fetch_user_counts.php"); // ✅ Fix directory
    const data = await response.json();
...
async function fetchProducts() {
  try {
      const response = await fetch("http://192.168.168.203/backend/Frontend/SuperAdmin/fetch_products.php?page=dashboard");
      const data = await response.json();
...
async function fetchRecentActivities() {
  try {
      const response = await fetch("http://192.168.168.203/backend/Frontend/Superadmin/fetch_recent_activities.php");
      const data = await response.json();
