        ...
        filteredProducts.forEach((product) => {
            const row = `
                <tr>
                    ...
                    <td>
                        <span class="report-count ${product.report_count > 0 ? 'reported' : ''}">
                            ${product.report_count} Report${product.report_count !== 1 ? 's' : ''}
                        </span>
                    </td>
                    <td>
                        <button class="more-btn" data-id="${product.id}">View More</button>
                    </td>
                </tr>
            `;
